...
document.addEventListener('click', function(e) {
  ...
  // যদি sidebar visible থাকে এবং ক্লিক sidebar বা বাটনের বাইরে হয়, sidebar বন্ধ করো
...
function loadSidebar() {
  const sidebarHtml = `
    ...
    <a href="surah_5.html">005 সূরা আল-মায়েদা</a>
    ...
    <a href="surah_19.html">019 সূরা মারইয়াম</a>
    <a href="surah_20.html">020 সূরা ত্বোহা</a>
    <a href="surah_21.html">021 সূরা আম্বিয়া</a>
    ...
    <a href="surah_36.html">036 সূরা ইয়াসীন</a>
    ...
    <a href="surah_45.html">045 সূরা জাসিয়া</a>
    ...
    <a href="surah_51.html">051 সূরা যারিয়াত</a>
    ...
    <a href="surah_56.html">056 সূরা ওয়াক্বিয়া</a>
    ...
    <a href="surah_75.html">075 সূরা কিয়ামাহ</a>
    ...
    <a href="surah_88.html">088 সূরা গাশিয়াহ</a>
    ...
    <a href="surah_98.html">098 সূরা বাইয়্যিনাহ</a>
    <a href="surah_99.html">099 সূরা যিলযাল</a>
    <a href="surah_100.html">100 সূরা আদিয়াত</a>
    <a href="surah_101.html">101 সূরা কারিয়া</a>
  ...
  if (sidebar) {
    ...
    // বর্তমান সূরার লিংকে 'active' ক্লাস যুক্ত করা
...
function changeFontSize(direction) {
    ...
    const currentArabicSize = parseFloat(window.getComputedStyle(arabicTexts[0]).fontSize);
    const currentTranslationSize = parseFloat(window.getComputedStyle(translationTexts[0]).fontSize);
    ...
    if (direction === 1) { // ফন্ট বড় করা
        ...
        if (currentArabicSize > 24) { // সর্বনিম্ন সীমা
            arabicTexts.forEach(el => el.style.fontSize = (currentArabicSize - 2) + 'px');
        }
        if (currentTranslationSize > 20) { // সর্বনিম্ন সীমা
            translationTexts.forEach(el => el.style.fontSize = (currentTranslationSize - 2) + 'px');
        }
    }
}
